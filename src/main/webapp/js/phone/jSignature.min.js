...
(function() {
    ...
    function x(b, a, c) {
        ...
        var h = $.fn.jSignature("globalEvents"),
            d = { width: "100%", height: "139px", sizeRatio: 4, color: "#000", "background-color": "#fff", "decor-color": "#eee", lineWidth: 0, minFatFingerCompensation: -10, showUndoButton: !1, readOnly: !1, data: [], signatureLine: !1 };
        $.extend(d, t(e));
        a && $.extend(d, a);
        this.settings = d;
