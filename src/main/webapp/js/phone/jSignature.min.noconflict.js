    ...
    */
    (function() {
        function t(b) {
            ...
            b = b[0];
            for (var h = !1; b && !e && !h;) {
                try { a = $(b).css("background-color") } catch (l) { a = "transparent" } "transparent" !== a && "rgba(0, 0, 0, 0)" !== a && (e = a);
                h = b.body;
                b = b.parentNode }
            b = /rgb[a]*\((\d+),\s*(\d+),\s*(\d+)/;
            var h = /#([AaBbCcDdEeFf\d]{2})([AaBbCcDdEeFf\d]{2})([AaBbCcDdEeFf\d]{2})/,
                m;
            a = void 0;
            (a = c.match(b)) ? m = { r: parseInt(a[1], 10), g: parseInt(a[2], 10), b: parseInt(a[3], 10) }: (a = c.match(h)) && (m = { r: parseInt(a[1], 16), g: parseInt(a[2], 16), b: parseInt(a[3], 16) });
            var d;
            e ? (a = void 0, (a = e.match(b)) ? d = { r: parseInt(a[1], 10), g: parseInt(a[2], 10), b: parseInt(a[3], 10) } : (a = e.match(h)) && (d = { r: parseInt(a[1], 16), g: parseInt(a[2], 16), b: parseInt(a[3], 16) })) : d = m ? 127 < Math.max.apply(null, [m.r, m.g, m.b]) ? { r: 0, g: 0, b: 0 } : { r: 255, g: 255, b: 255 } : { r: 255, g: 255, b: 255 };
            a = function(a) {
                return "rgb(" + [a.r, a.g, a.b].join(", ") + ")" };
            m && d ? (b = Math.max.apply(null, [m.r, m.g, m.b]), m = Math.max.apply(null, [d.r, d.g, d.b]), m = Math.round(m + -.75 * (m - b)), m = { r: m, g: m, b: m }) : m ? (m = Math.max.apply(null, [m.r, m.g, m.b]), b = 1, 127 < m &&
        ...
        function n(b, a, c, e, h) {
            ...
            this.context = a;
            if (b.length)
                for (var m = b.length, d, l, f = 0; f < m; f++) { d = b[f];
                    l = d.x.length;
                    c.call(a, d);
            ...
            this.startStroke = function(a) {
                if (a && "number" == typeof a.x && "number" == typeof a.y) { this._stroke = { x: [a.x], y: [a.y] };
                    ...
                    var b = this._stroke,
                        ...
                        e = this.context;
                    setTimeout(function() { c.call(e, b) }, 3);
                    return a }
                return null };
            this.addToStroke = function(a) {
                if (this.inStroke && "number" === typeof a.x && "number" === typeof a.y && 4 < Math.abs(a.x - this._lastPoint.x) + Math.abs(a.y - this._lastPoint.y)) {
                    ...
                    var c = this._stroke,
                        ...
                        h = this.context;
                    setTimeout(function() { e.call(h, c, b) }, 3);
                    return a
                }
                return null
            };
            this.endStroke = function() {
                ...
                if (a) {
                    var b = this._stroke,
                        ...
                        e = this.context,
                        h = this.changed;
                    setTimeout(function() { c.call(e, b);
                        h.call(e) }, 3);
                    return !0 }
                return null }
        }
        ...
        function x(b, a, c) {
            ...
            var h = $.fn.jSignature("globalEvents"),
                d = { width: "ratio", height: "ratio", sizeRatio: 4, color: "#000", "background-color": "#fff", "decor-color": "#eee", lineWidth: 0, minFatFingerCompensation: -10, showUndoButton: !1, readOnly: !1, data: [], signatureLine: !1 };
            $.extend(d, t(e));
            a && $.extend(d, a);
            this.settings = d;
            ...
            d.lineWidth = function(a, b) {
                return a ? a : Math.max(Math.round(b / 400), 2) }(d.lineWidth, a.width);
            this.lineCurveThreshold = 3 * d.lineWidth;
            d.cssclass && "" != $.trim(d.cssclass) && c.addClass(d.cssclass);
            this.fatFingerCompensation = 0;
            e = function(a) {
                var b, c, e = function(e) { e = e.changedTouches && 0 < e.changedTouches.length ? e.changedTouches[0] : e;
                        return new g(Math.round(e.pageX + b), Math.round(e.pageY + c) + a.fatFingerCompensation) },
                    d = new w(750, function() { a.dataEngine.endStroke() });
                this.drawEndHandler = function(b) {
                    if (!a.settings.readOnly) {
                        try { b.preventDefault() } catch (F) {}
                        d.clear();
                        a.dataEngine.endStroke() } };
                this.drawStartHandler = function(h) {
                    if (!a.settings.readOnly) { h.preventDefault();
                        var m = $(a.canvas).offset();
                        b = -1 * m.left;
                        c = -1 * m.top;
                        a.dataEngine.startStroke(e(h));
                        d.kick() } };
                this.drawMoveHandler = function(b) { a.settings.readOnly || (b.preventDefault(), a.dataEngine.inStroke && (a.dataEngine.addToStroke(e(b)), d.kick())) };
                return this
            }.call({}, this);
            (function(a, b, c) {
                var e = this.canvas,
                    h =
                    $(e);
                this.isCanvasEmulator ? (h.bind("mousemove.jSignature", c), h.bind("mouseup.jSignature", a), h.bind("mousedown.jSignature", b)) : (e.ontouchstart = function(h) { e.onmousedown = e.onmouseup = e.onmousemove = void 0;
                    ...
                    e.ontouchend = a;
                    e.ontouchstart = b;
                    e.ontouchmove = c }, e.onmousedown = function(d) {
        ...
        function y(b) {
            ...
            if (c) { b = c.initElement(b);
                c = 1;
                a && a.screen && a.screen.deviceXDPI && a.screen.logicalXDPI && (c = 1 * a.screen.deviceXDPI / a.screen.logicalXDPI);
                if (1 !== c) try { $(b).children("object").get(0).resize(Math.ceil(b.width * c), Math.ceil(b.height * c)), b.getContext("2d").scale(c, c) } catch (e) {}
                return !0 }
        ...
        var w = function(b, a) {
            ...
            v = function(b) {
                ...
                this.subscribe = function(a, b, e) { this.topics[a] ? this.topics[a].push([b, e]) : this.topics[a] = [
                        [b, e]
                    ];
            ...
            z = function(b, a, c, e, d) { b.beginPath();
                b.moveTo(a, c);
                b.lineTo(e, d);
                b.closePath();
                b.stroke() },
        ...
        x.prototype.resetCanvas = function(b, a) {
            ...
            h.lineCap =
                h.lineJoin = "round";
            if (e.signatureLine) {
                if (null != e["decor-color"]) { h.strokeStyle = e["decor-color"];
                    h.shadowOffsetX = 0;
                    h.shadowOffsetY = 0;
            ...
            h.changed = function(a, b, c) {
                return function() { b.publish(c + ".change");
        ...
        x.prototype.initializeCanvas = function(b) {
            ...
            c.css({ margin: 0, padding: 0, border: "none", height: "ratio" !== b.height && b.height ? b.height.toString(10) : 1, width: "ratio" !== b.width && b.width ? b.width.toString(10) : 1, "-ms-touch-action": "none", "touch-action": "none", "background-color": b["background-color"] });
            ...
            a.onselectstart = function(a) { a && a.preventDefault && a.preventDefault();
        ...
        (function(b) {
            ...
            function c(a, b) { this.find("canvas.jSignature").add(this.filter("canvas.jSignature")).data("jSignature.this").resetCanvas(a, b);
                return this }
            ...
            var h = new v;
            (function(a, b, c, d) {
                var e, h = function() { a.publish(b + ".parentresized") };
                c(d).bind("resize." + b, function() { e && clearTimeout(e);
                    e = setTimeout(h, 500) }).bind("mouseup." + b, function(c) { a.publish(b + ".windowmouseup") }) })(h, "jSignature", $, b);
            var f = {},
                g = {
                    "default": function(a) {
                ...
                l = { "native": function(a, b, c) { c(a) }, image: a, "image/png;base64": a, "image/jpeg;base64": a, "image/jpg;base64": a },
                k = function(a) {
                    var b = !1;
                ...
                n = {
                    init: function(a) {
                        return this.each(function() { k(this) || new x(this, a, f) }) },
                    destroy: function() {
                    ...
                    clear: c,
                    reset: c,
                    addPlugin: function(a, b, c) { p.hasOwnProperty(a) && (p[a][b] = c);
                        return this },
                    listPlugins: function(a) {
                        var b = [];
                        if (p.hasOwnProperty(a)) { a = p[a];
            ...
            $.fn.jSignature =
                function(a) {
                    if (a && "object" !== typeof a) {
                        ...
                        $.error("Method " + String(a) + " does not exist on jQuery.jSignature") } else return n.init.apply(this, arguments) }
        })(window)
    })();
    (function() {
        function t(k, g, n) { k = k.call(this);
            (function(g, k, n) { g.events.subscribe(n + ".change", function() { g.dataEngine.data.length ? k.show() : k.hide() }) })(this, k, g);
            (function(g, k, n) {
                var r = n + ".undo";
                k.bind("click", function() { g.events.publish(r) });
                g.events.subscribe(r, function() {
                    var k = g.dataEngine.data;
                    k.length && (k.pop(), g.resetCanvas(k)) }) })(this, k, this.events.topics.hasOwnProperty(g + ".undo") ? n : g) }
        $.fn.jSignature("addPlugin", "instance", "UndoButton", function(k) {
            this.events.subscribe("jSignature.attachingEventHandlers",
                function() {
                    if (this.settings[k]) {
                        var g = this.settings[k]; "function" !== typeof g && (g = function() {
    ...
    (function() {
        ...
        var x = function(d) { d = d.split("");
            ...
            f = function(d, b, a) { "string" === typeof d && ("image/jsignature;base30" === d.substring(0, 23).toLowerCase() && (d = d.substring(24)), a(z(d))) };
    ...
    (function() {
        ...
        function x(f, d, b) { d = ["M", g(f.x[0] - d, 2), g(f.y[0] - b, 2)];
            b = 1;
        ...
        function z(f, d) {
            return ["image/svg+xml;base64", D(w(f, d))] }(function(f, d) {
            "use strict";
